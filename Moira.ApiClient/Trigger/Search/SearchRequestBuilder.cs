...
using Moira.ApiClient.Trigger.Search.Pager;
using System.Collections.Generic;
using System.IO;
using System.Threading.Tasks;
using System.Threading;
using System;
namespace Moira.ApiClient.Trigger.Search
{
    /// <summary>
    ...
    public partial class SearchRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Moira.ApiClient.Trigger.Search.Pager.PagerRequestBuilder Pager
        {
            get => new global::Moira.ApiClient.Trigger.Search.Pager.PagerRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Moira.ApiClient.Trigger.Search.SearchRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Moira.ApiClient.Models.Dto.TriggersList?> GetAsync(Action<RequestConfiguration<global::Moira.ApiClient.Trigger.Search.SearchRequestBuilder.SearchRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Moira.ApiClient.Models.Dto.TriggersList> GetAsync(Action<RequestConfiguration<global::Moira.ApiClient.Trigger.Search.SearchRequestBuilder.SearchRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Moira.ApiClient.Trigger.Search.SearchRequestBuilder.SearchRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Moira.ApiClient.Trigger.Search.SearchRequestBuilder.SearchRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Moira.ApiClient.Trigger.Search.SearchRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Moira.ApiClient.Trigger.Search.SearchRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Moira.ApiClient.Trigger.Search.SearchRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// You can also add filtering by tags, for this purpose add query parameters tags[0]=test, tags[1]=test1 and so onFor example, `/api/trigger/search?tags[0]=test&amp;tags[1]=test1`
        /// </summary>
