...
namespace Moira.ApiClient.Model
{
    ...
    public partial class DtoTreeOfProblems : IValidatableObject
    {
        ...
        [JsonConstructor]
        public DtoTreeOfProblems(bool syntaxOk, Option<DtoProblemOfTarget> treeOfProblems = default)
        {
            SyntaxOk = syntaxOk;
    ...
    public class DtoTreeOfProblemsJsonConverter : JsonConverter<DtoTreeOfProblems>
    {
        ...
        public override DtoTreeOfProblems Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!syntaxOk.IsSet)
                throw new ArgumentException("Property is required for class DtoTreeOfProblems.", nameof(syntaxOk));
            ...
            return new DtoTreeOfProblems(syntaxOk.Value.Value, treeOfProblems);
        }
        ...
        {
            writer.WriteBoolean("syntax_ok", dtoTreeOfProblems.SyntaxOk);
