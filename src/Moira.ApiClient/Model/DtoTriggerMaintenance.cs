...
namespace Moira.ApiClient.Model
{
    ...
    public partial class DtoTriggerMaintenance : IValidatableObject
    {
        ...
        [JsonConstructor]
        public DtoTriggerMaintenance(Dictionary<string, int> metrics, Option<long?> trigger = default)
        {
            Metrics = metrics;
    ...
    public class DtoTriggerMaintenanceJsonConverter : JsonConverter<DtoTriggerMaintenance>
    {
        ...
        public override DtoTriggerMaintenance Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!metrics.IsSet)
                throw new ArgumentException("Property is required for class DtoTriggerMaintenance.", nameof(metrics));
            ...
            return new DtoTriggerMaintenance(metrics.Value, trigger);
        }
        ...
        {
            if (dtoTriggerMaintenance.Metrics == null)
