...
namespace Moira.ApiClient.Model
{
    ...
    public partial class MoiraScheduleDataDay : IValidatableObject
    {
        ...
        [JsonConstructor]
        public MoiraScheduleDataDay(bool enabled, Option<NameEnum?> name = default)
        {
            Enabled = enabled;
            NameOption = name;
            OnCreated();
    ...
    public class MoiraScheduleDataDayJsonConverter : JsonConverter<MoiraScheduleDataDay>
    {
        ...
        public override MoiraScheduleDataDay Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!enabled.IsSet)
                throw new ArgumentException("Property is required for class MoiraScheduleDataDay.", nameof(enabled));
            ...
            return new MoiraScheduleDataDay(enabled.Value.Value, name);
        }
        ...
        {
            writer.WriteBoolean("enabled", moiraScheduleDataDay.Enabled);
