...
namespace Moira.ApiClient.Model
{
    ...
    public partial class ApiWebConfig : IValidatableObject
    {
        ...
        [JsonConstructor]
        public ApiWebConfig(List<ApiWebContact> contacts, ApiFeatureFlags featureFlags, List<ApiMetricSourceCluster> metricSourceClusters, bool remoteAllowed, ApiSentry sentry, Option<string> supportEmail = default)
        {
            Contacts = contacts;
        ...
        public List<ApiWebContact> Contacts { get; set; }

        /// <summary>
        /// Gets or Sets FeatureFlags
        /// </summary>
        [JsonPropertyName("featureFlags")]
        public ApiFeatureFlags FeatureFlags { get; set; }

        /// <summary>
        /// Gets or Sets MetricSourceClusters
        /// </summary>
        [JsonPropertyName("metric_source_clusters")]
        public List<ApiMetricSourceCluster> MetricSourceClusters { get; set; }
        ...
        public ApiSentry Sentry { get; set; }
    ...
    public class ApiWebConfigJsonConverter : JsonConverter<ApiWebConfig>
    {
        ...
        public override ApiWebConfig Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!contacts.IsSet)
                throw new ArgumentException("Property is required for class ApiWebConfig.", nameof(contacts));

            if (!featureFlags.IsSet)
                throw new ArgumentException("Property is required for class ApiWebConfig.", nameof(featureFlags));

            if (!metricSourceClusters.IsSet)
                throw new ArgumentException("Property is required for class ApiWebConfig.", nameof(metricSourceClusters));

            if (!remoteAllowed.IsSet)
                throw new ArgumentException("Property is required for class ApiWebConfig.", nameof(remoteAllowed));

            if (!sentry.IsSet)
                throw new ArgumentException("Property is required for class ApiWebConfig.", nameof(sentry));
            ...
            return new ApiWebConfig(contacts.Value, featureFlags.Value, metricSourceClusters.Value, remoteAllowed.Value.Value, sentry.Value, supportEmail);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, ApiWebConfig apiWebConfig, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            writer.WriteBoolean("remoteAllowed", apiWebConfig.RemoteAllowed);
