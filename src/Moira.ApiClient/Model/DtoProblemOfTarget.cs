...
namespace Moira.ApiClient.Model
{
    ...
    public partial class DtoProblemOfTarget : IValidatableObject
    {
        ...
        [JsonConstructor]
        public DtoProblemOfTarget(string argument, int position, Option<string> description = default, Option<List<DtoProblemOfTarget>> problems = default, Option<string> type = default)
        {
            Argument = argument;
            Position = position;
    ...
    public class DtoProblemOfTargetJsonConverter : JsonConverter<DtoProblemOfTarget>
    {
        ...
        public override DtoProblemOfTarget Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!argument.IsSet)
                throw new ArgumentException("Property is required for class DtoProblemOfTarget.", nameof(argument));

            if (!position.IsSet)
                throw new ArgumentException("Property is required for class DtoProblemOfTarget.", nameof(position));
            ...
            return new DtoProblemOfTarget(argument.Value, position.Value.Value, description, problems, type);
        }
        ...
        {
            if (dtoProblemOfTarget.Argument == null)
            ...
            writer.WriteNumber("position", dtoProblemOfTarget.Position);
