...
namespace Moira.ApiClient.Model
{
    ...
    public partial class DtoNotifierState : IValidatableObject
    {
        ...
        [JsonConstructor]
        public DtoNotifierState(string actor, string state, Option<string> message = default)
        {
            Actor = actor;
            State = state;
    ...
    public class DtoNotifierStateJsonConverter : JsonConverter<DtoNotifierState>
    {
        ...
        public override DtoNotifierState Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!actor.IsSet)
                throw new ArgumentException("Property is required for class DtoNotifierState.", nameof(actor));

            if (!state.IsSet)
                throw new ArgumentException("Property is required for class DtoNotifierState.", nameof(state));
            ...
            return new DtoNotifierState(actor.Value, state.Value, message);
        }
