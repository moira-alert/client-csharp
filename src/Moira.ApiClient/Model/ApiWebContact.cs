...
namespace Moira.ApiClient.Model
{
    ...
    public partial class ApiWebContact : IValidatableObject
    {
        ...
        [JsonConstructor]
        public ApiWebContact(string label, string type, Option<string> help = default, Option<string> logoUri = default, Option<string> placeholder = default, Option<string> validation = default)
        {
            Label = label;
            Type = type;
            HelpOption = help;
 ...
 - moira.ru
    ...
    public class ApiWebContactJsonConverter : JsonConverter<ApiWebContact>
    {
        ...
        public override ApiWebContact Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!label.IsSet)
                throw new ArgumentException("Property is required for class ApiWebContact.", nameof(label));

            if (!type.IsSet)
                throw new ArgumentException("Property is required for class ApiWebContact.", nameof(type));
            ...
            return new ApiWebContact(label.Value, type.Value, help, logoUri, placeholder, validation);
        }
