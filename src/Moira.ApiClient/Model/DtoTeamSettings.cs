...
namespace Moira.ApiClient.Model
{
    ...
    public partial class DtoTeamSettings : IValidatableObject
    {
        ...
        [JsonConstructor]
        public DtoTeamSettings(List<DtoTeamContactWithScore> contacts, List<MoiraSubscriptionData> subscriptions, string teamId)
        {
            Contacts = contacts;
        ...
        public List<DtoTeamContactWithScore> Contacts { get; set; }
    ...
    public class DtoTeamSettingsJsonConverter : JsonConverter<DtoTeamSettings>
    {
        ...
        public override DtoTeamSettings Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!contacts.IsSet)
                throw new ArgumentException("Property is required for class DtoTeamSettings.", nameof(contacts));

            if (!subscriptions.IsSet)
                throw new ArgumentException("Property is required for class DtoTeamSettings.", nameof(subscriptions));

            if (!teamId.IsSet)
                throw new ArgumentException("Property is required for class DtoTeamSettings.", nameof(teamId));
            ...
            return new DtoTeamSettings(contacts.Value, subscriptions.Value, teamId.Value);
        }
