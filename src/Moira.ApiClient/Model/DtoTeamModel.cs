...
namespace Moira.ApiClient.Model
{
    ...
    /// DtoTeamModel
    /// </summary>
    public partial class DtoTeamModel : IValidatableObject
    {
        /// <summary>
        ...
        /// Gets or Sets Name
        /// </summary>
        /* <example>Infrastructure Team</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="DtoTeamModel" />
    /// </summary>
    public class DtoTeamModelJsonConverter : JsonConverter<DtoTeamModel>
    {
        /// <summary>
        /// Deserializes json to <see cref="DtoTeamModel" />
        /// </summary>
        ...
        public override DtoTeamModel Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="DtoTeamModel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="dtoTeamModel"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DtoTeamModel dtoTeamModel, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, dtoTeamModel, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DtoTeamModel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="dtoTeamModel"></param>
        /// <param name="jsonSerializerOptions"></param>
