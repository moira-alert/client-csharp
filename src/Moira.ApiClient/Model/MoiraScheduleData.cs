...
namespace Moira.ApiClient.Model
{
    ...
    public partial class MoiraScheduleData : IValidatableObject
    {
        ...
        [JsonConstructor]
        public MoiraScheduleData(List<MoiraScheduleDataDay> days, long endOffset, long startOffset, long tzOffset)
        {
            Days = days;
            EndOffset = endOffset;
        ...
        public List<MoiraScheduleDataDay> Days { get; set; }
    ...
    public class MoiraScheduleDataJsonConverter : JsonConverter<MoiraScheduleData>
    {
        ...
        public override MoiraScheduleData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!days.IsSet)
                throw new ArgumentException("Property is required for class MoiraScheduleData.", nameof(days));

            if (!endOffset.IsSet)
                throw new ArgumentException("Property is required for class MoiraScheduleData.", nameof(endOffset));

            if (!startOffset.IsSet)
                throw new ArgumentException("Property is required for class MoiraScheduleData.", nameof(startOffset));

            if (!tzOffset.IsSet)
                throw new ArgumentException("Property is required for class MoiraScheduleData.", nameof(tzOffset));
            ...
            return new MoiraScheduleData(days.Value, endOffset.Value.Value, startOffset.Value.Value, tzOffset.Value.Value);
        }
        ...
        {
            if (moiraScheduleData.Days == null)
            ...
            writer.WriteNumber("endOffset", moiraScheduleData.EndOffset);

            writer.WriteNumber("startOffset", moiraScheduleData.StartOffset);

            writer.WriteNumber("tzOffset", moiraScheduleData.TzOffset);
        }
    }
}
