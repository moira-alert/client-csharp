...
namespace Moira.ApiClient.Model
{
    ...
    public partial class ApiFeatureFlags : IValidatableObject
    {
        ...
        [JsonConstructor]
        public ApiFeatureFlags(string celebrationMode, bool isPlottingAvailable, bool isPlottingDefaultOn, bool isReadonlyEnabled, bool isSubscriptionToAllTagsAvailable)
        {
            CelebrationMode = celebrationMode;
            IsPlottingAvailable = isPlottingAvailable;
            IsPlottingDefaultOn = isPlottingDefaultOn;
            IsReadonlyEnabled = isReadonlyEnabled;
            IsSubscriptionToAllTagsAvailable = isSubscriptionToAllTagsAvailable;
            OnCreated();
        }
    ...
    public class ApiFeatureFlagsJsonConverter : JsonConverter<ApiFeatureFlags>
    {
        ...
        public override ApiFeatureFlags Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!celebrationMode.IsSet)
                throw new ArgumentException("Property is required for class ApiFeatureFlags.", nameof(celebrationMode));

            if (!isPlottingAvailable.IsSet)
                throw new ArgumentException("Property is required for class ApiFeatureFlags.", nameof(isPlottingAvailable));

            if (!isPlottingDefaultOn.IsSet)
                throw new ArgumentException("Property is required for class ApiFeatureFlags.", nameof(isPlottingDefaultOn));

            if (!isReadonlyEnabled.IsSet)
                throw new ArgumentException("Property is required for class ApiFeatureFlags.", nameof(isReadonlyEnabled));

            if (!isSubscriptionToAllTagsAvailable.IsSet)
                throw new ArgumentException("Property is required for class ApiFeatureFlags.", nameof(isSubscriptionToAllTagsAvailable));
            ...
            return new ApiFeatureFlags(celebrationMode.Value, isPlottingAvailable.Value.Value, isPlottingDefaultOn.Value.Value, isReadonlyEnabled.Value.Value, isSubscriptionToAllTagsAvailable.Value.Value);
        }
        ...
        {
            if (apiFeatureFlags.CelebrationMode == null)
            ...
            writer.WriteBoolean("isPlottingAvailable", apiFeatureFlags.IsPlottingAvailable);

            writer.WriteBoolean("isPlottingDefaultOn", apiFeatureFlags.IsPlottingDefaultOn);

            writer.WriteBoolean("isReadonlyEnabled", apiFeatureFlags.IsReadonlyEnabled);

            writer.WriteBoolean("isSubscriptionToAllTagsAvailable", apiFeatureFlags.IsSubscriptionToAllTagsAvailable);
        }
    }
}
