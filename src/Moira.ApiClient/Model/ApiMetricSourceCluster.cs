...
namespace Moira.ApiClient.Model
{
    ...
    public partial class ApiMetricSourceCluster : IValidatableObject
    {
        ...
        [JsonConstructor]
        public ApiMetricSourceCluster(string clusterId, string clusterName, int metricsTtl, string triggerSource)
        {
            ClusterId = clusterId;
    ...
    public class ApiMetricSourceClusterJsonConverter : JsonConverter<ApiMetricSourceCluster>
    {
        ...
        public override ApiMetricSourceCluster Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!clusterId.IsSet)
                throw new ArgumentException("Property is required for class ApiMetricSourceCluster.", nameof(clusterId));

            if (!clusterName.IsSet)
                throw new ArgumentException("Property is required for class ApiMetricSourceCluster.", nameof(clusterName));

            if (!metricsTtl.IsSet)
                throw new ArgumentException("Property is required for class ApiMetricSourceCluster.", nameof(metricsTtl));

            if (!triggerSource.IsSet)
                throw new ArgumentException("Property is required for class ApiMetricSourceCluster.", nameof(triggerSource));
            ...
            return new ApiMetricSourceCluster(clusterId.Value, clusterName.Value, metricsTtl.Value.Value, triggerSource.Value);
        }
        ...
        {
            if (apiMetricSourceCluster.ClusterId == null)
            ...
            if (apiMetricSourceCluster.ClusterName == null)
            ...
            if (apiMetricSourceCluster.TriggerSource == null)
            ...
            writer.WriteNumber("metrics_ttl", apiMetricSourceCluster.MetricsTtl);
