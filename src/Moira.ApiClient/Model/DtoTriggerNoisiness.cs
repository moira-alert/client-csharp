    ...
    public class DtoTriggerNoisinessJsonConverter : JsonConverter<DtoTriggerNoisiness>
    {
        ...
        public override DtoTriggerNoisiness Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!aloneMetrics.IsSet)
                throw new ArgumentException("Property is required for class DtoTriggerNoisiness.", nameof(aloneMetrics));

            if (!clusterId.IsSet)
                throw new ArgumentException("Property is required for class DtoTriggerNoisiness.", nameof(clusterId));

            if (!createdBy.IsSet)
                throw new ArgumentException("Property is required for class DtoTriggerNoisiness.", nameof(createdBy));

            if (!eventsCount.IsSet)
                throw new ArgumentException("Property is required for class DtoTriggerNoisiness.", nameof(eventsCount));

            if (!expression.IsSet)
                throw new ArgumentException("Property is required for class DtoTriggerNoisiness.", nameof(expression));

            if (!id.IsSet)
                throw new ArgumentException("Property is required for class DtoTriggerNoisiness.", nameof(id));

            if (!isRemote.IsSet)
                throw new ArgumentException("Property is required for class DtoTriggerNoisiness.", nameof(isRemote));

            if (!muteNewMetrics.IsSet)
                throw new ArgumentException("Property is required for class DtoTriggerNoisiness.", nameof(muteNewMetrics));

            if (!name.IsSet)
                throw new ArgumentException("Property is required for class DtoTriggerNoisiness.", nameof(name));

            if (!patterns.IsSet)
                throw new ArgumentException("Property is required for class DtoTriggerNoisiness.", nameof(patterns));

            if (!tags.IsSet)
                throw new ArgumentException("Property is required for class DtoTriggerNoisiness.", nameof(tags));

            if (!targets.IsSet)
                throw new ArgumentException("Property is required for class DtoTriggerNoisiness.", nameof(targets));

            if (!throttling.IsSet)
                throw new ArgumentException("Property is required for class DtoTriggerNoisiness.", nameof(throttling));

            if (!triggerSource.IsSet)
                throw new ArgumentException("Property is required for class DtoTriggerNoisiness.", nameof(triggerSource));

            if (!triggerType.IsSet)
                throw new ArgumentException("Property is required for class DtoTriggerNoisiness.", nameof(triggerType));

            if (!updatedBy.IsSet)
                throw new ArgumentException("Property is required for class DtoTriggerNoisiness.", nameof(updatedBy));

            if (!createdAt.IsSet)
                throw new ArgumentException("Property is required for class DtoTriggerNoisiness.", nameof(createdAt));

            if (!errorValue.IsSet)
                throw new ArgumentException("Property is required for class DtoTriggerNoisiness.", nameof(errorValue));

            if (!updatedAt.IsSet)
                throw new ArgumentException("Property is required for class DtoTriggerNoisiness.", nameof(updatedAt));

            if (!warnValue.IsSet)
                throw new ArgumentException("Property is required for class DtoTriggerNoisiness.", nameof(warnValue));
        ...
        {
            if (dtoTriggerNoisiness.AloneMetrics == null)
            ...
            if (dtoTriggerNoisiness.TriggerType == null)
            ...
            if (dtoTriggerNoisiness.UpdatedBy == null)
            ...
            writer.WriteNumber("events_count", dtoTriggerNoisiness.EventsCount);

            writer.WriteString("expression", dtoTriggerNoisiness.Expression);

            writer.WriteString("id", dtoTriggerNoisiness.Id);

            writer.WriteBoolean("is_remote", dtoTriggerNoisiness.IsRemote);

            writer.WriteBoolean("mute_new_metrics", dtoTriggerNoisiness.MuteNewMetrics);
            ...
            writer.WriteNumber("throttling", dtoTriggerNoisiness.Throttling);
            ...
            if (dtoTriggerNoisiness.CreatedAt != null)
            ...
            if (dtoTriggerNoisiness.ErrorValue != null)
                writer.WriteNumber("error_value", dtoTriggerNoisiness.ErrorValue.Value);
            else
            ...
            if (dtoTriggerNoisiness.UpdatedAt != null)
                writer.WriteString("updated_at", dtoTriggerNoisiness.UpdatedAt);
            else
                writer.WriteNull("updated_at");

            if (dtoTriggerNoisiness.WarnValue != null)
                writer.WriteNumber("warn_value", dtoTriggerNoisiness.WarnValue.Value);
            else
